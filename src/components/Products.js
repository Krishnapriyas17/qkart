 ...
 */
 ...
 const Products = () => { 
   ...
   * * @returns { Array.<Product> } * Array of objects with complete data on all available products * 
   * * API endpoint - "GET /products" * * Example for successful response from backend: 
   * * HTTP 200 * 
   * [ * 
   * { 
   * * "name": "iPhone XR", * 
   ...
   *  HTTP 500 * 
   * { * "success": false, * "message": "Something went wrong. Check the backend console for more details" * } 
   * */
   useEffect(()=>{ 
    performAPICall() 
  },[]) 
